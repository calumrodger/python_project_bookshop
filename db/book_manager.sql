...
INSERT INTO books(title, publisher_id, author, genre, stock, cost_price, sale_price, markup, blurb) VALUES ('PORTS', 4, 'Calum Rodger', 'poetry', 4, 3q.00, 5.00, 2.00, 'Classic twentieth century poems reimagined as videogame instructions.');
INSERT INTO books(title, publisher_id, author, genre, stock, cost_price, sale_price, markup, blurb) VALUES ('Rapel', 5, 'Ian Hamilton Finlay', 'concrete poetry', 5, 50.00, 150.00, 50.00, 'Classic twentieth century poems reimagined as videogame instructions.');
